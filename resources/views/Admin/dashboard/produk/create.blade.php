                                        ...
                                        <tbody>
                                            @foreach ($barang as $barang)
                                                <tr>
                                                    ...
                                                    <td>{{ $barang->stok }}</td>
                                                    <td>
                                                        <input type="number" class="form-control komponen-jumlah" name="jumlah_komponen[]" min="1"
                                                            max="{{ $barang->stok }}">
                                                    </td>
                                                    <td>
                                                        {{ $barang->harga }}
                                                        <input type="hidden" class="komponen-harga" name="komponen[]" value="{{ $barang->id }}"
                    ...
                    <div class="form-group">
                        ...
                        <div style="display: flex;" hidden>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="status" value="Belum Terjual" checked>
